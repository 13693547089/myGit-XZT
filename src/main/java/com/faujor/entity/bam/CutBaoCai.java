...
public class CutBaoCai implements Serializable {
	...
	public CutBaoCai(String liaiId, String status, String cutMonth, String liaiCode, String suppId, String suppName,
                     String createId, String creator, String fields, String isSpecial, Object fieldsBlob, String canceUser,
                     Date canceDate, Date createDate, String suppInfo) {
		super();
		this.liaiId = liaiId;
		this.status = status;
	...
	public String toString() {
		return "CutLiaison [liaiId=" + liaiId + ", status=" + status + ", cutMonth=" + cutMonth + ", liaiCode="
				...
				+ creator + ", fields=" + fields + ", isSpecial=" + isSpecial + ", fieldsBlob=" + fieldsBlob
				+ ", canceUser=" + canceUser + ", canceDate=" + canceDate + ", createDate=" + createDate + ", suppInfo="
				+ suppInfo + "]";
	}
