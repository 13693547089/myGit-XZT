...
public class TranPlanDetail implements Serializable{
	...
	private Float estDevQty; 	// 预计交货
	private Float sumQty; 	// 调拨小计
	...
	public Float getEstDevQty() {
		return estDevQty;
	}
	public void setEstDevQty(Float estDevQty) {
		this.estDevQty = estDevQty;
	}
