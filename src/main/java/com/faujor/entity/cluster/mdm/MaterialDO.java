...
public class MaterialDO implements Serializable {
	...
	private List<MaterialUnitDO> materialUnits;// 单位转换列表
	...
	public List<MaterialUnitDO> getMaterialUnits() {
		return materialUnits;
	}

	public void setMaterialUnits(List<MaterialUnitDO> materialUnits) {
