...
public class SysUserDO implements Serializable {
	...
	// 供应商关联组织机构的personId字段
	private Long orgSpersonId;

	private String sfnames;// 用户全路径
	// 角色
	...
	public Long getOrgSpersonId() {
		return orgSpersonId;
	}

	public void setOrgSpersonId(Long orgSpersonId) {
		this.orgSpersonId = orgSpersonId;
	}
