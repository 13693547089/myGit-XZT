...
public class QualPapers implements Serializable {
	...
	public QualPapers(String id, String papersId, String papersName, String papersType, Date startDate, Date endDate,
	...
	public String toString() {
		return "QualPapers [id=" + id + ", papersId=" + papersId + ", papersName=" + papersName + ", papersType="
