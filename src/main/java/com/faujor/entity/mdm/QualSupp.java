...
public class QualSupp implements Serializable {
	...
	public QualSupp(String suppId, String sapId, String srmId, String oaId, String categoryId, String category,
			...
			String status, Date registerTime, Date auditTime, String auditStatus, Integer firstTrialId,
			Date buyerAuditTime, Integer miniId, Date subOATime, String suppInfo, String provcity, String concat_col) {
		super();
		this.suppId = suppId;
		this.sapId = sapId;
		this.srmId = srmId;
		...
		this.concat_col = concat_col;
	}

	public String getConcat_col() {
		return concat_col;
	}

	public void setConcat_col(String concat_col) {
		this.concat_col = concat_col;
	}
	...
	/**
	 * @param lAY_CHECKED the lAY_CHECKED to set
	 */
	...
	public String toString() {
		return "QualSupp [suppId=" + suppId + ", sapId=" + sapId + ", srmId=" + srmId + ", oaId=" + oaId
				...
				+ miniId + ", subOATime=" + subOATime + ", suppInfo=" + suppInfo + ", provcity=" + provcity
