...
public class UserSuppMate implements Serializable{
	...
	public UserSuppMate(String id, Integer buyerId, String suppId, String mateId, String buyerRole, String creator,
			Date createTime, String modifier, Date updateTime, String version, Date startTime, Date endTime) {
		super();
		this.id = id;
	...
	public String toString() {
		return "UserSuppMate [id=" + id + ", buyerId=" + buyerId + ", suppId=" + suppId + ", mateId=" + mateId
				+ ", buyerRole=" + buyerRole + ", creator=" + creator + ", createTime=" + createTime + ", modifier="
				+ modifier + ", updateTime=" + updateTime + ", version=" + version + ", startTime=" + startTime
				+ ", endTime=" + endTime + "]";
	}
