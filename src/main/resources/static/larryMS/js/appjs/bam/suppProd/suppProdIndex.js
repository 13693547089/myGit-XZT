...
layui.use(['table','laydate','layer'], function() {
	...
	$("#confirmBtn").click(function(){
		...
		$.post(prefix+"/changeSuppProdStatus",{status:'已确认',json:json},function(res){
	...
	$("#refuseBtn").click(function(){
		...
		var json=JSON.stringify(ids);
		$.post(prefix+"/changeSuppProdStatus",{status:'已驳回',json:json},function(res){
			layer.msg("操作成功！",{time:1000});
			$("#searchBtn").click();
		});
	});
